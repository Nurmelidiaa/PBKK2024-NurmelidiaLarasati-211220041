      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            <li class="menu-header"><i class="fas fa-home"></i><span> Halaman Utama</span></li>
            <li class="nav-item{{ request()->is('penyewa') ? ' active' : '' }}"><a href="{{ url('/penyewa') }}"><i class="fas fa-user-friends"></i><span> Penyewa</span></a></li>
            <li class="nav-item{{ request()->is('kendaraan') ? ' active' : '' }}"><a href="{{ url('/kendaraan') }}"><i class="fas fa-car"></i><span> Kendaraan</span></a></li>
            <li class="nav-item{{ request()->is('kwitansi') ? ' active' : '' }}"><a href="{{ url('/kwitansi') }}"><i class="fas fa-file-invoice"></i><span> Kwitansi</span></a></li>
            <li class="nav-item{{ request()->is('sewa') ? ' active' : '' }}"><a href="{{ url('/sewa') }}"><i class="fas fa-car-side"></i><span> Sewa </span></a></li>
            <li class="nav-item{{ request()->is('invoice') ? ' active' : '' }}"><a href="{{ url('/invoice') }}"><i class="fas fa-file-invoice-dollar"></i><span> Invoice</span></a></li>
          </ul>
            </li>
          </ul>
